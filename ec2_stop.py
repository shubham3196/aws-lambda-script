...
def lambda_handler(event, context):
    ...
    response = client.publish(
        ...
        Message='All the EC2 on demand instances that are scheduled by AWS Lambda have been stopped',  # Custom Messages
        Subject='LeanApps AWS servers have been stopped' # Custom Subject
    )
